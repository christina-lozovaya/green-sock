...
function scriptsFunc() {
    return src([
        ...
        'node_modules/gsap/dist/gsap.js',  //для использования либы TweenMax для анимации js
        'node_modules/scrollmagic/scrollmagic/minified/ScrollMagic.min.js',  //подключаем все библиотеки, который используем
